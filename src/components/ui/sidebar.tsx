...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        // Deliberately no group-data-[collapsible=icon]:overflow-hidden
...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90%, computed once per mount (in an effect, not
  // during render, since Math.random is an impure function).
