...
DEFAULT_SETTINGS = [
    ...
    ("meal_cutoff_breakfast", "09:00", "Time (HH:MM) after which breakfast attendance is final - no more adds/removes"),
    ("meal_cutoff_lunch", "14:30", "Time (HH:MM) after which lunch attendance is final - no more adds/removes"),
    ("meal_cutoff_hitea", "17:30", "Time (HH:MM) after which hi-tea attendance is final - no more adds/removes"),
    ("meal_cutoff_dinner", "21:30", "Time (HH:MM) after which dinner attendance is final - no more adds/removes"),
