...
from backend.migrations import access, rooms, bookings, billing, inventory, kitchen, attendance, mess_billing, members

_DOMAINS = (access, rooms, bookings, billing, inventory, kitchen, attendance, mess_billing, members)
